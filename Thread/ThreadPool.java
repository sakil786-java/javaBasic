...
newCachedThreadPool(): The method creates a new thread pool
that creates the new threads when needed but will still use the previously created thread whenever they are available to use.
...
//manage thread in a efficient manner;
...
public class ThreadPool {
    public static void main(String[] args) {
        ...
        ExecutorService executorService = Executors.newFixedThreadPool(3);//how many thread will run concurrently at a time
       ...
       /* executorService.execute(thread7);
        ...
        executorService.shutdown();//explicitly shutdown the thread
    }
}
